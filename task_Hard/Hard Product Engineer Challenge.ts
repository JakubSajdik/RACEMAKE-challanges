 ...
 *   Or: npm install && npm run start:node  (Node uses @hono/node-server)
 *
 * Test with (from Task_hard, sample file next to this spec):
 ...
 *
 * Implementation lives in challenge-hard.ts (this file is types + sample telemetry only).
 *
 *
